import { X, Pin, Edit2, Trash2, FileText, Loader2 } from 'lucide-react';
...
const NoteModal = ({
  ...
  return (
    <>
      ...
      <div className="p-8 z-20 rounded-2xl border w-[90%] max-w-4xl h-[85vh] dark:bg-[#2D2D3A] bg-[#F8F5F2] shadow-xl border-[#E5E0D9] dark:border-[#3D3D4A] text-[#2D2D3A] dark:text-[#F8F5F2] fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 overflow-hidden flex flex-col">
        {/* Header */}
        <div className="flex justify-between items-start mb-4">
          <div>
            ...
            <div className="flex items-center gap-4">
              <span className="text-sm text-[#2D2D3A]/60 dark:text-[#F8F5F2]/60">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <X className="text-[#2D2D3A]/60 dark:text-[#F8F5F2]/60" size={24} />
            </button>
          </div>
        </div>
        ...
        <div className="flex gap-2 mb-4">
          {enhancedContent && (
            <button
              ...
              className="text-xs px-3 py-1.5 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-800 dark:text-emerald-300 rounded-full font-medium"
            >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium transition-colors ${isEnhancing || isEnhanced
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium transition-colors ${isSummarizing || isSummarized
              ? 'bg-[#E5E0D9] dark:bg-[#3D3D4A] text-[#2D2D3A]/40 dark:text-[#F8F5F2]/40 cursor-not-allowed'
        ...
        <div className="flex-1 overflow-y-auto pr-4 scrollbar-thin scrollbar-thumb-emerald-200 dark:scrollbar-thumb-emerald-800/30 scrollbar-track-transparent">
          <div className="prose dark:prose-invert max-w-none">
            <p className="text-[#2D2D3A]/80 dark:text-[#F8F5F2]/80 leading-relaxed whitespace-pre-wrap">
