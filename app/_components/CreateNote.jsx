      ...
      <div className="fixed inset-0 bg-black bg-opacity-80 backdrop-blur-sm z-10"></div>
        <div className="p-4 z-20 rounded-lg border-2 w-[640px] dark:bg-emerald-900 bg-dbtn border-emerald-400 text-white fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
         <span className="flex justify-end">
          ...
          id="message"
          rows="4"
          className="block p-2.5 w-[600px] h-[450px] text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:border-emerald-500 dark:placeholder-gray-400 dark:text-white dark:emerald-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."
          value={content}
